...
import 'package:murious_appp/screen/my_events/7days_event/7event_desc/7event_descUi.dart';

class SevenGlass extends StatelessWidget {
      ...
      child: GestureDetector(
        onTap: () {
          ...
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => SevenEventDescUi(
                eventName: eventName,
                eventTime: eventTime,
