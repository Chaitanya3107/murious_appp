...
class SevenPhoto extends StatefulWidget {
  const SevenPhoto({super.key, required this.eventName});
  final String eventName;

  @override
  State<SevenPhoto> createState() => _SevenPhotoState();
}

final String? uid = AuthService().getCurrentUid();

class _SevenPhotoState extends State<SevenPhoto> {
  ...
  void loadSubmittedText() async {
    ...
    setState(() {
      submittedTextPhoto = prefs.getString('submittedTextPhoto') ?? '';
    });
  }
  ...
  Future<void> uploadFile(String uid, String eventName) async {
    ...
    try {
      ...
      setState(() {
        submittedTextPhoto = 'Submitted';
        saveSubmittedText(submittedTextPhoto);
      });
    } catch (e) {
  ...
  Widget build(BuildContext context) {
    ...
    if (submittedTextPhoto.isNotEmpty) {
